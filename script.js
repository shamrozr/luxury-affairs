...
a, button, input, textarea, select, .marquee-item, .product-card, .nav-arrow, .close-zoom-btn, .video-card, img {
...
.carousel-container, .marquee-container {
    ...
    /* Ensure immediate response to pan gestures, no zoom */
